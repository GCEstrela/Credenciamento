                ...
                using (var cmd = _dataBase.InsertText("EmpresasContratos", conn))
                {
                    try
                    {
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("EmpresaContratoID",
                            entity.EmpresaContratoId, true)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("EmpresaID", entity.EmpresaId, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("NumeroContrato",
                            entity.NumeroContrato, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Descricao", entity.Descricao, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Emissao", entity.Emissao, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Validade", entity.Validade, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Terceirizada", entity.Terceirizada, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Contratante", entity.Contratante, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("IsencaoCobranca",
                            entity.IsencaoCobranca, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("TipoCobrancaID",
                            entity.TipoCobrancaId, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("CobrancaEmpresaID",
                            entity.CobrancaEmpresaId, false)));
                        ...
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("NomeResp", entity.NomeResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("TelefoneResp", entity.TelefoneResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("CelularResp", entity.CelularResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("EmailResp", entity.EmailResp, false)));
                        cmd.Parameters.Add(
        ...
        public EmpresaContrato BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamSelect("EmpresaContratoId", DbType.Int32, id).Igual()));
                    ...
                    try
                    {
                        ...
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(
                                new ParamSelect("NumeroContrato", DbType.Int32, objects, 0).Igual()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("Descricao", DbType.String, objects, 1).Like()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("Emissao", DbType.Date, objects, 2).Like()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("Validade", DbType.Date, objects, 3).Like()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("Contratante", DbType.String, objects, 4)
                                .Like()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(
                                new ParamSelect("TipoCobrancaID", DbType.Int32, objects, 5).Igual()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("EmailResp", DbType.String, objects, 6).Like()));
            ...
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.UpdateText("EmpresasContratos", conn))
                {
                    try
                    {
                        ...
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamUpdate("NumeroContrato",
                            entity.NumeroContrato, false)));
                        cmd.Parameters.Add(
                        ...
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("Terceirizada", entity.Terceirizada, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("Contratante", entity.Contratante, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamUpdate("IsencaoCobranca",
                            entity.IsencaoCobranca, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamUpdate("TipoCobrancaID",
                            entity.TipoCobrancaId, false)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamUpdate("CobrancaEmpresaID",
                            entity.CobrancaEmpresaId, false)));
                        ...
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("NomeResp", entity.NomeResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("TelefoneResp", entity.TelefoneResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("CelularResp", entity.CelularResp, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("EmailResp", entity.EmailResp, false)));
                        cmd.Parameters.Add(
        ...
        public void Remover(EmpresaContrato entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.DeleteText("EmpresasContratos", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamDelete("EmpresaContratoId", entity.EmpresaContratoId)
                                .Igual()));
