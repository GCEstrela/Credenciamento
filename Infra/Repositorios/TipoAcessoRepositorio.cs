        ...
        public void Criar(TipoAcesso entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.InsertText("TiposAcessos", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("TipoAcessoID", entity.TipoAcessoId, true)));
                        cmd.Parameters.Add(
        ...
        public TipoAcesso BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamSelect("TipoAcessoId", DbType.Int32, id).Igual()));
        ...
        public void Alterar(TipoAcesso entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.UpdateText("TiposAcessos", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("TipoAcessoID", entity.TipoAcessoId, true)));
                        cmd.Parameters.Add(
        ...
        public void Remover(TipoAcesso entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.DeleteText("TiposAcessos", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamDelete("TipoAcessoId", entity.TipoAcessoId).Igual()));
