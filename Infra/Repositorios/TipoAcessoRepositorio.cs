...
namespace IMOD.Infra.Repositorios
{
    public class TipoAcessoRepositorio : ITipoAcessoRepositorio
    {
        ...
        public void Criar(TipoAcesso entity)
        {
            ...
            {
                using (var cmd = _dataBase.InsertText("TipoAcesso", conn))
                {
                    try
                    {
        ...
        public TipoAcesso BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.SelectText("TipoAcesso", conn))
        ...
        public void Alterar(TipoAcesso entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.UpdateText("TipoAcesso", conn))
                {
                    try
                    {
        ...
        public void Remover(TipoAcesso entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.DeleteText("TipoAcesso", conn))
                {
                    try
                    {
