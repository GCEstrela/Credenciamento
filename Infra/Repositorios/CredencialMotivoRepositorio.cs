        ...
        public ICollection<CredencialMotivo> Listar(params object[] objects)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    try
                    {
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamSelect("CredencialmotivoID",DbType.Int16, objects, 0)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamSelect("Descricao", DbType.String, objects, 1)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamSelect("Tipo", DbType.Int16, objects, 2)));
