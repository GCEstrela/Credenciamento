        ...
        public void Criar(Pendencia entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.InsertText("Pendencias", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("PendenciaID", entity.PendenciaId, true)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("TipoPendenciaID",
                            entity.TipoPendenciaId, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Descricao", entity.Descricao, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("DataLimite", entity.DataLimite, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamInsert("Impeditivo", entity.Impeditivo, false)));
                        cmd.Parameters.Add(
        ...
        public Pendencia BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamSelect("PendenciaId", DbType.Int32, id).Igual()));
            ...
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    try
                    {
                        ...
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("DataLimite", DbType.Date, objects, 1).Like()));
                        cmd.CreateParameterSelect(
                            _dataBase.CreateParameter(new ParamSelect("Impeditivo", DbType.Boolean, objects, 2)
                                .Igual()));
        ...
        public void Alterar(Pendencia entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.UpdateText("Pendencias", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("PendenciaID", entity.PendenciaId, true)));
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamUpdate("TipoPendenciaID",
                            entity.TipoPendenciaId, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("Descricao", entity.Descricao, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("DataLimite", entity.DataLimite, false)));
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamUpdate("Impeditivo", entity.Impeditivo, false)));
                        cmd.Parameters.Add(
        ...
        public void Remover(Pendencia entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.DeleteText("Pendencias", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamDelete("PendenciaId", entity.PendenciaId).Igual()));
