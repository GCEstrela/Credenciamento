        ...
        public TipoAtividade BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamSelect("TipoAtividadeId", DbType.Int32, id).Igual()));
                    ...
                    try
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(
                                new ParamDelete("TipoAtividadeId", entity.TipoAtividadeId).Igual()));
