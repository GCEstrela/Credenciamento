        ...
        public TipoEquipamento BuscarPelaChave(int id)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
...

                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamSelect("TipoEquipamentoId", DbType.Int32, id).Igual()));
        ...
        public void Remover(TipoEquipamento entity)
        {
            using (var conn = _dataBase.CreateOpenConnection())
            {
                using (var cmd = _dataBase.DeleteText("TiposEquipamentos", conn))
                {
                    ...
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(new ParamDelete("TipoEquipamentoId", entity.TipoEquipamentoId)
                                .Igual()));
