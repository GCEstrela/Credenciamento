                ...
                using (var cmd = _dataBase.InsertText("TecnologiasCredenciais", conn))
                {
                    try
                    {
                        cmd.Parameters.Add(_dataBase.CreateParameter(new ParamInsert("TecnologiaCredencialID",
                            entity.TecnologiaCredencialId, true)));
                        cmd.Parameters.Add(
                    ...
                    try
                    {
                        cmd.Parameters.Add(
                            _dataBase.CreateParameter(
                                new ParamSelect("TecnologiaCredencialId", DbType.Int32, id).Igual()));
                ...
                using (var cmd = _dataBase.DeleteText("TecnologiasCredenciais", conn))
                {
                    try
                    {
                        cmd.Parameters.Add(_dataBase.CreateParameter(
                            new ParamDelete("TecnologiaCredencialID", entity.TecnologiaCredencialId).Igual()));
