...
namespace iModSCCredenciamento.Funcoes
{
    public class Global
    {
        ...
        public static string _connectionString = "Data Source=GCTEC20\\SQLEXPRESS;Initial Catalog=D_iModCredenciamento;User ID=imod;Password=imod;Min Pool Size=5;Max Pool Size=15;Connection Reset=True;Connection Lifetime=600;Trusted_Connection=no;MultipleActiveResultSets=True";
