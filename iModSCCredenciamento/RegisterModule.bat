...
if EXIST "%~dp0iModSCCredenciamento.dll" GOTO OUTPUT_FOLDER
if EXIST "%~dp0bin\debug\iModSCCredenciamento.dll" GOTO PROJECT_DIR
GOTO WRONG_DIR

:OUTPUT_FOLDER:
SET path_dll="%~dp0iModSCCredenciamento.dll"
goto REG_EDIT

:PROJECT_DIR:
SET path_dll="%~dp0bin\debug\iModSCCredenciamento.dll"
