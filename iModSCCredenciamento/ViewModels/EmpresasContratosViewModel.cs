...
namespace iModSCCredenciamento.ViewModels
{
    public class EmpresasContratosViewModel : ViewModelBase
    {
        ...
        private List<ClasseEmpresasContratos.EmpresaContrato> _ContratosTemp = new List<ClasseEmpresasContratos.EmpresaContrato>();
        ...
        PopupPesquisaContrato popupPesquisaContrato;
        ...
        public ClasseEmpresasContratos.EmpresaContrato ContratoSelecionado
        {
            get
            {
                return this._ContratoSelecionado;
            }
            set
            {
                this._ContratoSelecionado = value;
        ...
        public void OnAtualizaCommand(object empresaID)
        {
            ...
            Thread CarregaColecaoContratos_thr = new Thread(() => CarregaColecaoContratos(Convert.ToInt32(empresaID)));
        ...
        public void OnAbrirArquivoCommand()
        {
            try
            {
                try
                {
                    ...
                    if (_ArquivoPDF == null)
                    {
                        string _xmlstring = CriaXmlImagem(ContratoSelecionado.EmpresaContratoID);
        ...
        public void OnSalvarEdicaoCommand()
        {
            ...
            {
                HabilitaEdicao = false;
                System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(typeof(ClasseEmpresasContratos));

                ObservableCollection<ClasseEmpresasContratos.EmpresaContrato> _EmpresasContratosTemp = new ObservableCollection<ClasseEmpresasContratos.EmpresaContrato>();
                ClasseEmpresasContratos _ClasseEmpresasContratosTemp = new ClasseEmpresasContratos();
        ...
        public void OnSalvarAdicaoCommand()
        {
            try
            {
                ...
                ObservableCollection<ClasseEmpresasContratos.EmpresaContrato> _EmpresasContratosPro = new ObservableCollection<ClasseEmpresasContratos.EmpresaContrato>();
                ClasseEmpresasContratos _ClasseEmpresasContratosPro = new ClasseEmpresasContratos();
                ...
                InsereContratoBD(xmlString);
                Thread CarregaColecaoContratos_thr = new Thread(() => CarregaColecaoContratos(ContratoSelecionado.EmpresaID));
                CarregaColecaoContratos_thr.Start();
        ...
        public void OnPesquisarCommand()
        {
            try
            {
                ...
                popupPesquisaContrato.EfetuarProcura += new EventHandler(On_EfetuarProcura);
        ...
        public void On_EfetuarProcura(object sender, EventArgs e)
        {
            ...
            string _numerocontrato = ((string[])vetor)[1];
        ...
        private void CarregaColecaoContratos(int empresaID, string _seguradora = "", string _numeroapolice = "")
        {
            try
            {
                string _xml = RequisitaContratos(empresaID, _seguradora, _numeroapolice);
        ...
        public void CarregaColecaoMunicipios(string _EstadoUF = "%")
        {
        ...
        private void CarregaColecaoStatuss()
        {
            try
            {
                ...
                string _xml = RequisitaStatuss();

                XmlSerializer deserializer = new XmlSerializer(typeof(ClasseStatus));
                XmlDocument xmldocument = new XmlDocument();
                xmldocument.LoadXml(_xml);
                TextReader reader = new StringReader(_xml);
                ClasseStatus classeStatus = new ClasseStatus();
        ...
        private string RequisitaStatuss()
        {
            try
            {
                ...
                _ClasseStatus.AppendChild(_Statuss);
                 ...
                 SqlConnection _Con = new SqlConnection(Global._connectionString);_Con.Open();
                SqlCommand _sqlcmd = new SqlCommand("select * from Status", _Con);
                SqlDataReader _sqldatareader = _sqlcmd.ExecuteReader();
                while (_sqldatareader.Read())
                {
        ...
        private string CriaXmlImagem(int empresaContratoID)
        {
            try
            {
                ...
                SqlCommand SQCMDXML = new SqlCommand("Select * From EmpresasContratos Where EmpresaContratoID = " + empresaContratoID + "", _Con);
