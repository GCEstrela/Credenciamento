...
namespace IMOD.CredenciamentoDeskTop.Windows
{
    ...
    public partial class PopUpFiltrosAutorizacoesInvalidas : Window
    {
        ...
        private void button_ClickFiltrar(object sender, RoutedEventArgs e)
        {
            ...
            ((RelatoriosViewModel)DataContext).OnRelatorioAutorizacoesInvalidasFiltroCommand(checkTipo, empresa, motivoCredencialSelecionados, dataIni, dataFim, flaTodasDevolucaoEntregue, flaSimNaoDevolucaoEntregue);
