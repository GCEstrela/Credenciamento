...
if EXIST "%~dp0IMOD.CredenciamentoDeskTop.dll" GOTO OUTPUT_FOLDER
if EXIST "%~dp0bin\debug\IMOD.CredenciamentoDeskTop.dll" GOTO PROJECT_DIR
GOTO WRONG_DIR

:OUTPUT_FOLDER:
SET path_dll="%~dp0IMOD.CredenciamentoDeskTop.dll"
goto REG_EDIT

:PROJECT_DIR:
SET path_dll="%~dp0bin\debug\IMOD.CredenciamentoDeskTop.dll"
