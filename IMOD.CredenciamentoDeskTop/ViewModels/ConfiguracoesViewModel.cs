    ...
    public class ConfiguracoesViewModel : ViewModelBase
    {
        ...
        public void VisualizarCrach(LayoutCrachaView rpt)
        {
            try
            {
                ...
                //_viewModel.BuscarAnexo(_viewModel.Entity.);
                ...
                colaboradorcrdencialteste.ColaboradorCredencialId = 9999;
                ...
                if (colaboradorcrdencialteste.Estrangeiro)
                {
                    ...
                    txt_RG_RNE.Text = colaboradorcrdencialteste.RNE.ToString();
                }
                else
                {
                    TextObject txtRNE = (TextObject)relatorio.ReportDefinition.ReportObjects["Text1"];
                    ...
                    TextObject txt_RG_RNE = (TextObject)relatorio.ReportDefinition.ReportObjects["obj_RG_RNE"];
                    txt_RG_RNE.Text = "9999999999";// colaboradorcrdencialteste.Rg.ToString();
                }
                var colaboradorCursosCracha = _auxiliaresService.ColaboradorCursoService.ListarView(colaboradorcrdencialteste.ColaboradorId, null, true);
