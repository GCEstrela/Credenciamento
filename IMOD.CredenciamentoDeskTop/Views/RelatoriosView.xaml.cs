...
namespace IMOD.CredenciamentoDeskTop.Views
{
    ...
    public partial class RelatoriosView : UserControl
    {
        ...
        private void BotaoColaboradorEmpresaClick(object sender, RoutedEventArgs e)
        {
            try
            {
                popupFiltrosColaboradorPorEmpresa = new PopUpFiltrosColaboradorPorEmpresa();
                popupFiltrosColaboradorPorEmpresa.ShowDialog();
            }
            catch (Exception ex)
            {
                Utils.TraceException(ex);
        ...
        private void BotaoHabilicataoColaboradorEmpresaClick(object sender, RoutedEventArgs e)
        {
            try
            {
                popupFiltrosColaboradorPorEmpresaPeriodo = new PopUpFiltrosColaboradorPorEmpresaPeriodo(28);
